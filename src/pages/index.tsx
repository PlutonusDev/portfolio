            ...
            <div id="projects" className="relative z-40">
                <div className="container max-w-7xl px-8 lg:mx-auto py-24">
                    ...
                    <ul className="divide-y divide-gray-200 mt-8">
                        <Project title={intl.formatMessage({ id: "projects.portfolio.heading" })} date={intl.formatMessage({ id: "projects.portfolio.date" })} imageurl="/projects/portfolio.jpg" summary={intl.formatMessage({ id: "projects.portfolio.summary" })} href="/" tags={[{ label: "TypeScript", icon: <SiTypescript /> }, { label: "NodeJS", icon: <SiNodedotjs /> }, { label: "NextJS", icon: <SiNextdotjs /> }]} />
                        <Project title="NextJS Portfolio Builder" date="Jan 2025" imageurl="https://opengraph.githubassets.com/5bd879bdd04e44e685b13917cf7819d766dc6892c79e2c492b76d61bf803c43d/PlutonusDev/nextjs-portfolio-builder" summary="A powerful and flexible monorepo template designed to streamline the creation and management of your web design portfolio." href="https://github.com/PlutonusDev/nextjs-portfolio-builder" tags={[{ label: "TypeScript", icon: <SiTypescript /> }, { label: "NodeJS", icon: <SiNodedotjs /> }, { label: "NextJS", icon: <SiNextdotjs /> }]} />
